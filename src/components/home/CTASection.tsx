  ...
  return (
    <section className="py-24 bg-gradient-to-br from-teal-600 to-teal-800 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <span className="inline-block bg-white/10 border border-white/20 text-teal-100 text-xs font-semibold uppercase tracking-widest px-4 py-2 rounded-full mb-6">
        ...
        <p className="text-teal-100 text-lg mb-10 max-w-xl mx-auto leading-relaxed">
          Take the first step towards a healthier, more confident smile. Our team is
          ready to welcome you at Dental Brass Tacks, Sector 48, Gurgaon.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/contact"
            className="inline-flex items-center justify-center gap-2.5 bg-white text-teal-700 hover:bg-teal-50 px-8 py-4 rounded-2xl font-semibold text-base transition-all shadow-xl hover:shadow-2xl active:scale-95"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2.5 bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-2xl font-semibold text-base transition-all shadow-xl hover:shadow-2xl active:scale-95"
          >
